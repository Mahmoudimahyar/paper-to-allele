...
from abo_repass import boxes_of  # noqa: E402
...
def run(facts: Path, persian_db: Path, ocr_db: Path, *, dry_run: bool) -> Counter[str]:
        ...
        if reading.status is AboStatus.RESOLVED:
            ...
            con.execute(
                ...
                (
                    ...
                    json.dumps(
                        [[b.x0, b.y0, b.x1, b.y1] for b in reading.value_boxes]
                        or (
                            [
                                [
                                    reading.value_box.x0,
                                    reading.value_box.y0,
                                    reading.value_box.x1,
                                    reading.value_box.y1,
                                ]
                            ]
                            if reading.value_box
                            else []
                        )
                    ),
                    now,
